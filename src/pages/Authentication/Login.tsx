      ...
      <div className="px-6 py-4">
        ...
        <form>
          ...
          <div className="flex items-center justify-between mt-4">
            <Link 
              href="#"
              className="text-sm text-red-500 dark:text-gray-200 hover:text-gray-500"
            >
              Forget Password?
            </Link>

            <Button className="px-6 py-2 text-sm font-medium tracking-wide text-white capitalize rounded-sm cursor-pointer">
              Sign In
            </Button>
          </div>
          <div className='w-full  mt-4'>
